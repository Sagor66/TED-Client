    ...
    >
      ...
      <div className="font-fredoka flex flex-col md:flex-row justify-around text-gray-300 font-semibold text-xl">
        <div className="flex flex-col items-center gap-4 justify-center">
          ...
          <FontAwesomeIcon
            className="fa-2xl text-gray-400 hover:text-indigo-500"
            icon={faDiscord}
          />
        </div>
        <div className="flex flex-col items-center gap-4 justify-center">
          <h4>Slack</h4>
          <FontAwesomeIcon
            className="fa-2xl text-gray-400 hover:text-yellow-500"
            icon={faSlack}
          />
        </div>
        <div className="flex flex-col items-center gap-4 justify-center">
          ...
          <FontAwesomeIcon
            className="fa-2xl text-gray-400 hover:text-sky-500"
            icon={faTelegram}
          />
        </div>
        <div className="flex flex-col items-center gap-4 justify-center">
          ...
          <FontAwesomeIcon
            className="fa-2xl text-gray-400 hover:text-orange-500"
            icon={faReddit}
          />
        </div>
        <div className="flex flex-col items-center gap-4 justify-center">
          <h4>Forumbee</h4>
          <FontAwesomeIcon
            className="fa-2xl text-gray-400 hover:text-emerald-500"
            icon={faForumbee}
          />
        </div>
      </div>
